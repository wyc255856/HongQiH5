...
//        NSLog(@"%f",progress);
    ...
    //成功和失败回调
    [operation setCompletionBlockWithSuccess:^(CAR_AFHTTPRequestOperation *operation, id responseObject) {
    ...
    } failure:^(CAR_AFHTTPRequestOperation *operation, NSError *error) {
