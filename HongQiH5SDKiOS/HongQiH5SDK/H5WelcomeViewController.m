...
@interface H5WelcomeViewController (){
    int _timeCount;
    BOOL Finish;
    BOOL Splash;
    BOOL H5Visitor;
...
@implementation H5WelcomeViewController
...
- (void)goNext {
    ...
    if(![[H5ShareManager shareInstance] isBlankString:strCarName]){
        ...
        H5ChooseCarModelViewController *vc = [[H5ChooseCarModelViewController alloc] init];
