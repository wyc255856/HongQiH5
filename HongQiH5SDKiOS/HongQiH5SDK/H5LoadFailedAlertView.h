...
@class H5LoadFailedAlertView;

@protocol LoadFailedAlertViewDelegate <NSObject>

- (void)loadFailedAlertView:(H5LoadFailedAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;

@end


@interface H5LoadFailedAlertView : UIView
